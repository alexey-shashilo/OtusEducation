package org.lecture.lecture16.demo.demo03.tests.unit;

import org.lecture.lecture16.demo.assertions.Assertions;
import org.lecture.lecture16.demo.demo03.app.service.FactorialApplication;
import org.lecture.lecture16.demo.demo03.app.service.FactorialCalculator;
import org.lecture.lecture16.demo.demo03.app.service.IOService;
import org.lecture.lecture16.demo.demo03.tests.unit.fakes.FactorialCalculatorSpy;
import org.lecture.lecture16.demo.demo03.tests.unit.fakes.IOServiceSpy;
...
public class FactorialApplicationTest {
    ...
    public void testAppFlow() {
        ...
        try {
            ...
            IOService ioServiceSpy = (IOService) new IOServiceSpy(actualFlow);
            FactorialCalculator factorialCalculatorSpy = (FactorialCalculator) new FactorialCalculatorSpy(actualFlow);
